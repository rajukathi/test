        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <ul>
                    ...
                    <li><input type="text" name="search" id="search" class="datepicker"></li>
                    <li><input type="button" name="btn_search" id="btn_search" class="btn btn-primary" value="search"></li>
                    <li>
                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="category_add" autofocus>
        ...
        function getPostList(date) {
            $.ajax({
                ...
                success: function(data) {
                    $('#append-tabledata').html('');
                    $('#postTable').prepend(data);
                },
            });
        }
